...
const heroData = [
  {
    ...
    naslov: "STARKE FUNDAMENTE FÜR DIE ZUKUNFT BAUEN",
    opis: "Mit innovativen Lösungen, hochwertigen Materialien und einem erfahrenen Team schaffen wir Bauwerke, die Generationen überdauern.",
    gumb: "Kontaktieren Sie uns",
    link: "kontakt_de.html"
  },
  {
    slika: "index/hero-2.jpg",
    naslov: "ZUVERLÄSSIGKEIT, DIE BESTÄNDIG IST",
    opis: "Unsere Arbeit basiert auf Präzision, Vertrauen und langjähriger Erfahrung im Bau komplexer Objekte.",
    gumb: "Mehr über uns",
    link: "o_nas_de.html"
  },
  {
    slika: "index/hero-3.jpg",
    naslov: "BAUEN FÜR DIE ZUKUNFT",
    opis: "Wir setzen auf moderne Bau-Lösungen, die den Lebensraum nachhaltig verbessern.",
    gumb: "Unsere Leistungen",
    link: "storitve_de.html"
  }
];
